...
@section('content')
    <form action="{{ route('route_real_estate_edit', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" class="form-control" id="val-email"
                                                name="area"value="{{ $data->area }}" placeholder="Your valid email..">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" class="form-control" id="val-password"
                                                name="price"value="{{ $data->price }}" placeholder="Choose a safe one..">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" id="val-suggestions" name="desc" rows="5"
                                                placeholder="What would you like to see?">{{ $data->desc }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-currency"
                                                name="address"value="{{ $data->address }}" placeholder="$21.60">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <select class="form-control" id="val-skill" name="cate">
                                                @foreach ($cate as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $data->id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
