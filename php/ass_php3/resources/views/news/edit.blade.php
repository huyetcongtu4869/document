...
@section('content')
    <form action="{{ route('route_news_edit', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="val-username" name="title"
                                            value="{{ $data->title }}" placeholder="Enter a username..">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <select class="form-control" id="val-skill" name="cate">
                                        ...
                                        @foreach ($cate as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $data->cate == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-currency">Ảnh tin tức <span
                                        class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
