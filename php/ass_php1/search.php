                ...
                <div class="control">
                    ...
                    <div class="control-action">
                        ...
                        <form action="search.php" method="post">
                            ...
                            <a href="search.php?id=<?php echo $value["id"] ?>"><button id="search"><img src="./image/img-daboard/Search.png" alt=""></button></a>
                        </form>
                        </div>
                        <a href="./view/add-new-product.php"><button class="add">Add New Product</button></a>
                    </div>
                </div>
                <table>
                    <thead>
