                    ...
                    <div class="control-action">
                        <div class="search">
                            ...
                            <form action="search.php" method="post">
                                ...
                                <a href="search.php<?php echo $value["id"] ?>"><button id="search" name="btn-search"><img src="./image/img-daboard/Search.png" alt=""></button></a>
                            </form>
                        </div>
                        <a href="./view/add-new-product.php"><button class="add" name="btn-login">Add New Product</button></a>
                    </div>
                </div>
                <table>
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($products as $key => $value) : ?>
                            <tr>
                                ...
                                <td class="img-table">
                                    <div><img src="<?php echo $value["productImage"] ?>" alt=""></div>
                                </td>
                                <td><?php echo $value["productPrice"] ?></td>
                                <td><?php echo $value["productDesc"] ?></td>
                                <td class="action">
                                    <a href="./view/update-product.php?id=<?php echo $value["id"] ?>"><button class="up">Update</button></a>
                                    <a href="./controller/delete-product.php?id=<?php echo $value["id"] ?>"onclick="return confirm('Bạn có xác nhận xóa không?')"><button class="de">Delete</button></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
