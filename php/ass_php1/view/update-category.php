...
<body>
    ...
    <div class="container">
        ...
        <nav>
            ...
            $id = $_GET["id"];
            $query2 = "select * from categoryname where id=$id";
            $item = getOne($query2);
            ...
            <form action="../controller/save-update-category.php" method="POST" enctype="multipart/form-data">
                ...
                <label for="">Mời bạn nhập tên danh mục</label><br>
                <input type="text" name="categoryName"value="<?php echo $item["categoryName"] ?>">
                <input type="file" name="categoryImage" id="file" value="<?php echo $item["categoryImage"] ?>">
